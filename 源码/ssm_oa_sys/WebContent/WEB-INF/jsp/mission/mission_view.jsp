					...
					<div class="media">
						<div class="media-left">
							<div class="avatar avatar-lg avatar-circle">
								<img class="img-responsive" src="/ssm_oa_sys/upload/employee/${missionInfo.auther.pic }" alt="avatar"/>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="m-h-lg lh-xl">
								...
								<p><c:if test="${missionInfo.pic!=null }"><img src="/ssm_oa_sys/upload/mission/${missionInfo.pic }" width="300" height="300"></c:if></p>
							</div>
						</div>
					</div>
				</div>
								...
								<form action="delete_comment.action" method="post">	
									...
									<div class="media-left">
										<div class="avatar avatar-lg avatar-circle">
											...
											<img src="/ssm_oa_sys/upload/employee/${map.key.pic  }" >
										</div>
									</div>
