					...
					<div class="media">
						<div class="media-left">
							<div class="avatar avatar-lg avatar-circle">
								<!-- 头像 -->
								<img class="img-responsive" src="/ssm_oa_sys/upload/employee/${mail.otherside.pic }" alt="avatar"/>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="m-h-lg lh-xl">
								...
								<!-- 图片附件 -->
								<p><c:if test="${mail.pic != null}"><img src="/ssm_oa_sys/upload/mail/${mail.pic }" width="300" height="300"></c:if></p>
							</div>
						</div>
					</div>
				</div>
